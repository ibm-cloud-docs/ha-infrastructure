...
3.	Copy the files from [vpc-ha-iac GitHub repository](https://github.com/IBM-Cloud/wes-ha-automation){: external} folder to the project folder that you created in the Terraform installation folder.
